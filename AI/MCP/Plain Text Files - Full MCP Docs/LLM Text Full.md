...
<Tabs>
  ...
  <Tab title="Java">
    ...
    * Brave Search API key
    ...
    6. Required dependencies in pom.xml:
    ...
    8. MCP Server Configuration (`mcp-servers-config.json`):
...
<AccordionGroup>
  ...
  <Accordion title="Weather API Issues">
    **Error: Failed to retrieve grid point data**
    ...
    7. The coordinates are outside the US
    8. The NWS API is having issues
    9. You're being rate limited
...
3. MCP servers **MUST** implement [OAuth 2.0 Protected Resource Metadata](https://datatracker.ietf.org/doc/html/draft-ietf-oauth-resource-metadata-13).
...
3. MCP servers that also act as an AS:
   4. **SHOULD** implement token rotation for enhanced security
   5. **SHOULD** restrict token lifetimes based on security requirements
